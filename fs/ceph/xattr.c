...
#ifdef CONFIG_SYNO_CEPH_IDENTIFY_POOL_XATTR_IS_ID
		ret = ceph_fmt_xattr(val, size, "id-%lld", pool);
#else
...
#ifdef CONFIG_SYNO_CEPH_WINACL
extern struct xattr_handler ceph_xattr_synoacl_access_handler;
#endif /* CONFIG_SYNO_CEPH_WINACL */
/*
...
#endif
#ifdef CONFIG_SYNO_CEPH_WINACL
	&ceph_xattr_synoacl_access_handler,
#endif /* CONFIG_SYNO_CEPH_WINACL */
