...
EXPORT_SYMBOL(syno_hint_add);
EXPORT_SYMBOL(syno_hint_tree_init);
EXPORT_SYMBOL(syno_hint_free);
EXPORT_SYMBOL(syno_md_hint_init);
EXPORT_SYMBOL(syno_hint_tree_clear);
EXPORT_SYMBOL(syno_hint_first);
EXPORT_SYMBOL(syno_hint_remove);
EXPORT_SYMBOL(syno_md_hint_exit);
