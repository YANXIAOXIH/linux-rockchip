...
{
	pr_debug("%s\n", __func__);
	reset_control_deassert(ve_rstc_bist);
	reset_control_deassert(ve_rstc);
	clk_prepare_enable(ve_clk);
}

static void rtk_ve1_power_off(void)
{
	pr_debug("%s\n", __func__);
	clk_disable_unprepare(ve_clk);
