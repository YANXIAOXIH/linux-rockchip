...
#include <linux/sched.h>     // 定义了 struct task_struct, PF_KTHREAD 等
#include <linux/mm_types.h>
#include <linux/mm.h>        // 定义了 pgprot_t 等内存管理相关的类型
#include <linux/fs.h>        // 包含了大量基础定义，通常是必须的
