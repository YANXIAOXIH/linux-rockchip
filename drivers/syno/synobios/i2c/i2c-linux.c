...
#include <linux/i2c.h>
#if defined(CONFIG_SYNO_TI_816X) || defined(CONFIG_SYNO_RK3588)|| defined(CONFIG_SYNO_RTD1619) || defined(CONFIG_SYNO_RTD1619B)|| defined(CONFIG_SYNO_V1000) || defined(CONFIG_SYNO_V1000SOFS) || defined(CONFIG_SYNO_R1000)
#define I2C_BUS_NO 1
