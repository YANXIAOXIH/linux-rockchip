...
static int  __maybe_unused my_atoi(const char *name)
{
	int val = 0;
...
static SYNO_CPU_MAPPING gSynoCPUMapping[] = {
	...
	{CPU_RK3588, "Rockchip, RK3588, SoC, 8"},
...
#endif /*SYNO_HAVE_KERNEL_VERSION(3,10,0)*/ 
{
	...
	static SYNO_CPU_MAPPING __maybe_unused  cpu_mapping = { .cpu_number =
							cpu_model_synofmt };
	...
	if (CPU_UNKNOWN == p_cpu_mapping->id && *cpu_model_synofmt) {
		static SYNO_CPU_MAPPING __maybe_unused cpu_mapping = { .cpu_number = cpu_model_synofmt };
